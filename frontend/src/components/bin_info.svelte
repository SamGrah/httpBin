...
<div class="m-11 grid grid-cols-1 gap-1 justify-items-center w-4/6">
  <p class="mb-4 text-center font-bold text-3xl">Bin <i>7tqid7</i> Has Been Created</p>
