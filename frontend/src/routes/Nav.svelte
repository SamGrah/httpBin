<nav class="fixed w-screen" style="background-color: #21CEAB;">
	<div class="max-w-10xl mx-auto">
		<div class="relative flex items-center justify-between h-16 mx-8">
			...
			<button
				type="button"
				class="bg-gray-800 p-1 mr-4 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
			>
				<span class="sr-only">View notifications</span>
				<div class="span12">
					<a href="https://github.com/SamGrah/requestbin.git">
						<i class="fab fa-github fa-2x hover:opacity-80" style="color: #21CEAB;" /></a
					>
				</div>
			</button>
		</div>
